    ...
    <div className="main_div">
        <div className='child-div'>
            <figure>
                ...
                <figcaption>Add your kart items</figcaption>
            </figure>
            <div className="addItems">
                ...
                {
                    toggleButton?<i className=" far fa-edit add-btn" onClick={addItem}></i>:<i className=" fa fa-solid fa-plus" onClick={addItem}></i>
                }
